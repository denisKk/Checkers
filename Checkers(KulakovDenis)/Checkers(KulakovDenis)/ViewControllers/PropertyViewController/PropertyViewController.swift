...
final class PropertyViewController: UIViewController {
    ...
    @IBOutlet private var boardSizeSegment: UISegmentedControl!
    @IBOutlet private var secondPlayerNameTextField: UITextField!
    @IBOutlet private var startGameButton: BorderButton!
    @IBOutlet private var timeLimitPicker: UIPickerView!
...
extension PropertyViewController {
    ...
    func setupSegmentedControl() {
        boardSizeSegment.selectedSegmentTintColor = (view as? GradientBackgroundView)?.startColor ?? .orange
...
extension PropertyViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(
        ...
        forComponent component: Int) -> NSAttributedString? {
            NSAttributedString(
                string: TimeType.allCases[row].description(),
